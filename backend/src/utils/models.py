...
STRATEGY_RE                 = "gold_diggers_copy"
STRATEGY_REVERSAL_RUNNER        = "reversal_runner"
...
STRATEGY_NAMES = {
    ...
    STRATEGY_RE:                "Gold Diggers VIP Copy",
...
STRATEGY_DESCRIPTIONS = {
    ...
    STRATEGY_RE: (
        "**Gold Diggers VIP Copy** — trades signals generated by the Reversal Engine.\n\n"
        "The Reversal Engine reverse-engineers the Gold Diggers VIP methodology: Asia range, "
    ...
    STRATEGY_REVERSAL_RUNNER: (
        "**Reversal Runner** — wide-SL ladder built from a backtest of 259 Gold Diggers VIP "
    ...
    STRATEGY_ADAPTIVE_RUNNER: (
        "**Adaptive Runner** — widens the SL like Reversal Runner, but caps the widened "
        ...
        "**Mechanism:**\n"
        "- SL: min(4 × stated SL distance, 20pt) same as Reversal Runner, then capped again at "
        ...
        "many TPs the signal actually has (same shape as Reversal Runner/Signal Climber — no "
        "fixed 8-slot ladder applied to a 3-TP signal, which silently drops most of the "
        "position with nothing to close it).\n"
        "- SL moves to breakeven at TP1 (not delayed to TP2 like Reversal Runner) — the stop is "
    ...
    STRATEGY_ADAPTIVE_RUNNER_2: (
        "**Adaptive Runner 2** — fixed 10pt SL, Reversal Runner's back-loaded close "
        ...
        "TP6 = 15%, TP7 = 15%, TP8 = all remaining (same table as Reversal Runner, "
    ...
    STRATEGY_LIMIT_RUNNER: (
        ...
        "previous TP price each level after, same as Reversal Runner.\n\n"
