...
from forex_trader.core import core_app_update as cau
from forex_trader.remote import client as rc
from forex_trader.remote import server as rs
...
def test_hello_and_status_carry_the_commit_and_its_reason(monkeypatch, tmp_path, repo):
    ...
    from forex_trader.remote import ip_check
