...
def test_tp_level_buy_highest_reached():
    ...
    assert maxtp._tp_level_from_extreme("BUY", 2412.0, lambda i: tps.get(i)) == "TP1,TP2"


def test_tp_level_sell_highest_reached():
    tps = {1: 2395.0, 2: 2390.0, 3: 2385.0}
    assert maxtp._tp_level_from_extreme("SELL", 2388.0, lambda i: tps.get(i)) == "TP1,TP2"


def test_tp_level_none_mid_ladder_not_treated_as_stop():
    tps = {1: 2405.0, 2: None, 3: 2415.0}
    assert maxtp._tp_level_from_extreme("BUY", 2420.0, lambda i: tps.get(i)) == "TP1,TP3"
