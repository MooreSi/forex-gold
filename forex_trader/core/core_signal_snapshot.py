...
from forex_trader.core.core_indicators import ema_last, rsi_last
...
async def _tf_indicators(bridge: Any, tf: str) -> Optional[dict]:
    ...
    try:
        from forex_trader.core.dpm_engine import compute_atr, compute_adx
...
async def capture_snapshot(bridge: Any, row: dict,
    ...
    regime = None
    try:
        from forex_trader.reversal_engine.level_detector import get_session
