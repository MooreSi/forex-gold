...
from forex_trader.core.ea_bridge import EA_PORTABLE_STRATEGIES
from forex_trader.core.core_fees_sizing import CONTRACT_SIZE
...
def test_broker_tp_is_set_for_fixed_rr():
    ...
    import inspect
    from forex_trader.core import core_open_trade
...
def test_engine_dispatch_has_explicit_branch_not_scale_out_fallthrough():
    ...
    holds."""
    import inspect
    from forex_trader.core import engine
